...
const Home = () => {
  ...
  const trendingCrops = [
    { id: 1, name: "Tomato", price: 40, pastPrice: 45, change: "-11%", demand: "High", qty: "₹/kg", imageUrl: "https://images.unsplash.com/photo-1592534106566-74f440642117?w=400&h=400&fit=crop", region: "Maharashtra", farmer: "Rajesh Patil" },
    { id: 2, name: "Onion", price: 35, pastPrice: 40, change: "-12%", demand: "Very High", qty: "₹/kg", imageUrl: "https://images.unsplash.com/photo-1599599810694-b3e63ca5fbb3?w=400&h=400&fit=crop", region: "Gujarat", farmer: "Amit Singh" },
    { id: 3, name: "Wheat", price: 55, pastPrice: 52, change: "+5%", demand: "Medium", qty: "₹/kg", imageUrl: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&h=400&fit=crop", region: "Punjab", farmer: "Harjit Kaur" },
    { id: 4, name: "Cotton", price: 6500, pastPrice: 6200, change: "+4%", demand: "High", qty: "₹/bale", imageUrl: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&h=400&fit=crop", region: "Karnataka", farmer: "Suresh Kumar" },
  ];
  ...
  const categories = [
    { name: "Vegetables", count: "2,450+", imageUrl: "https://images.unsplash.com/photo-1566028588640-f7f75c57cff5?w=400&h=400&fit=crop", color: "from-green-50 to-emerald-50" },
    { name: "Grains & Pulses", count: "1,890+", imageUrl: "https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=400&h=400&fit=crop", color: "from-amber-50 to-yellow-50" },
    { name: "Fruits", count: "1,230+", imageUrl: "https://images.unsplash.com/photo-1559827260-dc66d52bef19?w=400&h=400&fit=crop", color: "from-red-50 to-pink-50" },
    { name: "Spices", count: "680+", imageUrl: "https://images.unsplash.com/photo-1596040999221-c23afd1e6288?w=400&h=400&fit=crop", color: "from-orange-50 to-red-50" },
    { name: "Dairy & Eggs", count: "520+", imageUrl: "https://images.unsplash.com/photo-1585707734119-516ddecf1e90?w=400&h=400&fit=crop", color: "from-blue-50 to-cyan-50" },
    { name: "Seeds & Plants", count: "340+", imageUrl: "https://images.unsplash.com/photo-1585707734119-516ddecf1e90?w=400&h=400&fit=crop", color: "from-teal-50 to-green-50" },
  ];

  const featuredFarmers = [
    { id: 1, name: "Rajesh Patil", crops: "Tomato, Onion, Pepper", rating: 4.9, sales: "2.5K+", state: "Maharashtra", badge: "Top Seller", imageUrl: "https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=400&fit=crop" },
    { id: 2, name: "Harjit Kaur", crops: "Wheat, Rice, Maize", rating: 4.8, sales: "1.8K+", state: "Punjab", badge: "Certified", imageUrl: "https://images.unsplash.com/photo-1465014015322-faf14899202e?w=400&h=400&fit=crop" },
    { id: 3, name: "Suresh Kumar", crops: "Cotton, Sugarcane, Corn", rating: 4.7, sales: "1.5K+", state: "Karnataka", badge: "Trusted", imageUrl: "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=400&h=400&fit=crop" },
  ];

  const whyChooseUs = [
    { icon: Users, title: "Direct Connection", desc: "No middlemen, connect directly with farmers" },
    { icon: Truck, title: "Fast Logistics", desc: "Bulk delivery within 2-3 days across states" },
    { icon: TrendingUp, title: "Live Market Rates", desc: "Real-time pricing based on market demand" },
    { icon: Shield, title: "Verified Farmers", desc: "All sellers are verified and certified" },
  ];
  ...
  return (
    <div className="bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="inline-block bg-teal-500/20 border border-teal-400 rounded-full px-4 py-2 mb-4">
                  <span className="text-sm font-semibold text-teal-200">🌍 India's #1 Agri Marketplace</span>
                </div>
                <h1 className="text-6xl font-bold mb-6 leading-tight">
                  <span className="bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">Real Mandi Prices</span>
                  <br />
                  <span className="text-white">Direct from Farmers</span>
                </h1>
                <p className="text-xl text-slate-300 mb-8 font-light">
                  No middlemen. No markup. Just fair prices and fresh agricultural products delivered to your door. Connecting 15K+ farmers with 60K+ buyers across India.
                </p>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center gap-3 mb-12">
            ...
            <div>
              <h2 className="text-4xl font-bold text-slate-900">Live Market Rates</h2>
              <p className="text-slate-600 text-sm font-light">Today's trending crops and prices</p>
            </div>
          </div>
            ...
            {trendingCrops.map((crop, idx) => (
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <img src={crop.imageUrl} alt={crop.name} className="w-20 h-20 object-cover rounded-lg" />
                  <span className={`px-3 py-1 rounded-full text-xs font-bold ${crop.change.includes('-') ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
                    {crop.change}
                  </span>
                </div>
                <h3 className="text-xl font-bold text-slate-900 mb-2">{crop.name}</h3>
                <p className="text-sm text-slate-500 mb-4 font-light">{crop.region}</p>
                
                <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-lg p-4 mb-4">
                  <p className="text-3xl font-bold text-teal-600 mb-1">{crop.price}</p>
                  <p className="text-xs text-slate-600">per {crop.qty.split('/')[1]}</p>
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {categories.map((cat, idx) => (
              ...
              >
                ...
                <p className="text-xs text-slate-600 font-light">{cat.count} products</p>
              </button>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-slate-900 mb-12 text-center">Top Farmers This Week</h2>
            ...
            {featuredFarmers.map((farmer, idx) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <span className="bg-teal-100 text-teal-700 px-3 py-1 rounded-full text-xs font-bold border border-teal-300">✓ {farmer.badge}</span>
                </div>
                <h3 className="text-2xl font-bold text-slate-900 mb-2">{farmer.name}</h3>
                <p className="text-sm text-slate-600 mb-4 font-light">{farmer.state}</p>
                <div className="bg-slate-50 rounded-lg p-4 mb-4">
                  <p className="text-xs text-slate-600 mb-2 font-light">Specializes in:</p>
                  <p className="font-semibold text-slate-900">{farmer.crops}</p>
                </div>
                <div className="flex justify-between items-center mb-4">
                  <span className="text-sm"><strong>⭐ {farmer.rating}</strong> rating</span>
                  <span className="text-sm text-slate-600 font-light">{farmer.sales} sales</span>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-4xl font-bold text-slate-900 mb-12 text-center">Why Choose Bharat Mandi?</h2>
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 via-cyan-600 to-teal-600 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
          <h2 className="text-5xl font-bold text-white mb-6">Join India's Largest Agri Network</h2>
          <p className="text-xl text-teal-100 mb-8 font-light max-w-2xl mx-auto">
            Whether you're a farmer looking to sell directly or a buyer seeking fresh produce at real mandi prices
          </p>
