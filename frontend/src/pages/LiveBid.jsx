...
const LiveBid = () => {
  const activeBids = [
    {
      id: 1,
      item: "Organic Tomatoes (20 quintals)",
      startPrice: 35,
      currentBid: 42,
      bids: 12,
      endTime: "2h 15m",
      seller: "Rajesh Patil",
      imageUrl:
        "https://shop.trueharvestseeds.org/wp-content/uploads/2023/01/Organic-Beef-Tomato-Seeds-Brandywine.jpg",
    },
    {
      id: 2,
      item: "Wheat (50 quintals)",
      startPrice: 48,
      currentBid: 56,
      bids: 8,
      endTime: "45m",
    ...
    },
    {
      ...
      seller: "Suresh Kumar",
      imageUrl:
        "https://tiimg.tistatic.com/fp/1/007/020/raw-white-cotton-bale-839.jpg",
    },
    {
      id: 4,
      item: "Coconut Bunch (500)",
      startPrice: 12000,
      currentBid: 15500,
      bids: 10,
      endTime: "1h 20m",
      seller: "Krishnan",
      imageUrl:
        "https://img.freepik.com/free-photo/coconut-fruit_1203-2411.jpg?semt=ais_hybrid&w=740&q=80",
    },
    {
      id: 5,
      item: "Groundnut (30 quintals)",
      startPrice: 5500,
      currentBid: 6100,
      bids: 7,
      endTime: "55m",
    ...
    },
    {
      ...
      seller: "Vikram Singh",
      imageUrl:
        "https://www.netafimindia.com/cdn-cgi/image/format=auto,fit=crop,quality=80,width=750/contentassets/1ee574fcc0034296914f11b31713e081/sugarcane-with-dripline.png?v=492fbb",
    },
  ];

  const pastBids = [
    {
      item: "Rice (25 quintals)",
      finalPrice: 2250,
      soldTo: "Bharat Traders",
      profit: "+8%",
    },
    {
      item: "Mango (10 quintals)",
      finalPrice: 15000,
      soldTo: "Fresh Produce Ltd",
      profit: "+12%",
    },
    {
      item: "Spices Mix (5 quintals)",
      finalPrice: 45000,
      soldTo: "Masala Corp",
      profit: "+15%",
    },
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-gradient-to-r from-red-600 to-pink-600 text-white rounded-2xl p-12 mb-16">
          ...
          <p className="text-xl font-light">
            Buy direct from farmers in real-time auctions. Best prices
            guaranteed!
          </p>
        </div>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-4">
            {activeBids.map((bid, idx) => (
              <div
                key={idx}
                className="bg-white border-2 border-slate-200 rounded-2xl p-6 hover:border-red-400 hover:shadow-lg transition-all hover:scale-105"
              >
                ...
                <div className="bg-gradient-to-r from-slate-50 to-slate-100 rounded-xl p-6 mb-4 grid grid-cols-3 gap-4">
                  <div>
                    <p className="text-xs text-slate-600 font-light mb-1">
                      Starting Price
                    </p>
                  ...
                  <div className="border-l-2 border-r-2 border-slate-300 pl-4 pr-4">
                    ...
                    <p className="text-xs text-green-600 font-semibold mt-1">
                      +
                      {(
                        ((bid.currentBid - bid.startPrice) / bid.startPrice) *
                        100
                      ).toFixed(1)}
                      %
                    </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-green-100 rounded-lg p-3 text-center">
                    <p className="text-sm font-bold text-green-700">
                      {bid.profit} profit vs starting bid
                    </p>
                  </div>
                </div>
              </div>
